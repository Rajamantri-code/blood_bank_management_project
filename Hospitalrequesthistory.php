                        ...
                        include "Database.php";
                            ...
                            if($res->num_rows > 0)
                            {
                                foreach($res as $donorDetails)
                                {
                                  ...
                                  <td>{$donorDetails['paitent_name']}</td>
                                  <td>{$donorDetails['paitent_age']}</td>
                                  <td>{$donorDetails['paitent_diseas']}</td>
                                  <td>{$donorDetails['paitent_blood']}</td>
                                  <td>{$donorDetails['paitent_unit']}</td>";
                            ...
                            header("Hospitalrequesthistory.php");
