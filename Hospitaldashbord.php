            ...
            <div class="card bg-light">
              <div class="card-body">
                ...
                <div>
                  ...
                  <?php
                  include "Database.php";
                   $sql= "SELECT status FROM `patient` WHERE Hospital_id=1 and status=0";
                  $result= $conn->query($sql);
                  $hospitalblood_request_count = mysqli_num_rows($result);
                  $total_req_count = $hospitalblood_request_count ; 
                   echo "$total_req_count  ";
            ...
            <div class="card bg-light">
              <div class="card-body">
                ...
                <div>
                  ...
                  <?php
                  include "Database.php";
                  $sql= "SELECT status FROM `patient` WHERE Hospital_id=1 and status=1";
                 $result= $conn->query($sql);
                 $hospitalblood_request_count = mysqli_num_rows($result);
                 $total_req_count = $hospitalblood_request_count ; 
                  echo "$total_req_count  ";
            ...
            <div class="card bg-light">
              <div class="card-body">
                ...
                <div>
                  ...
                  <?php
                  include "Database.php";
                   $sql= "SELECT status FROM `patient` WHERE Hospital_id=1 and status=2";
                   $result= $conn->query($sql);
                   $hospitalblood_request_count = mysqli_num_rows($result);
